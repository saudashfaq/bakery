...
@section('content')
    ...
    <div class="main">
        ...
        <h2>Create Ready-Made Product </h2>
        <br/>
                    ...
                    <div class=" form-inline">
                        <div class="form-group">
                            <div class="col-md-13">
                                ...
                                <select class="form-control input-sm" name="attribute[0][attributeHead_id]" id="attributeHead"
                                        style="width:160px;">
                        ...
                        <div class="form-group">
                            <div class="col-md-13">
                                ...
                                <select class="form-control input-sm" name="attribute[0][attribute_id]" id="attribute0" style="width:160px;">
                        ...
                        <button type="button" id="add_attribute_button" class="btn btn-success mb-2 " onclick = "attributeSection()"  style="width:80px;"> Add</button>
...
{{--jScript code --}}
    ...
    <script>
        ...
        function attributeSection(){
            ...
            $('#attribute_section0').append('<div class=" form-inline"><div class="col-md-13"> <label ' +
                ...
                '    <div class="form-group"> <div class="col-md-13"> <label for="size">Attributes </label> ' +
