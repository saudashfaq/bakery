	...
	bindHandlers: function() {
		...
		if (this.isTouch) {
			this.listenTo($(document), {
				...
				// touchend will continue to be broken until admin does a shorttap/scroll, but this is best we can do.
...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	hasDayInteractions: true, // can admin click/select ranges of time?
	...
	dayTouchStart: function(ev) {
		...
		// HACK to prevent a admin's clickaway for unselecting a range or an event
	...
	// Creates a listener that tracks the admin's drag across day elements.
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the admin's mouse is over. null if over nothing
	...
	unrenderEvents: function() {
		this.handleSegMouseout(); // trigger an eventMouseout if admin's mouse is over an event
		this.clearDragListeners();
	...
	// Executes a handler for any a admin-interaction on a segment.
...
DayGrid.mixin({
	...
	showSegPopover: function(row, col, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the admin clicks elsewhere, hide the popover
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	isRTL: false,
	isSelected: false, // boolean whether a range of time is admin-selected or not
	selectedEvent: null,
	...
	// Computes the new date when the admin hits the prev button, given the current date
	...
	// Computes the new date when the admin hits the next button, given the current date
...
/*
Responsible for event rendering and admin-interaction.
