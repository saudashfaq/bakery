...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    function makeKeyInfo(mainType, mapResult) {
	        ...
	        // in echarts. id can be specified by admin, or auto generated.
	    ...
	    function filterBySubType(components, condition) {
	        ...
	        // subType is undefined in admin payload.
	    ...
	    layout.mergeLayoutParam = function (targetOption, newOption, opt) {
	        ...
	        function merge(names) {
	            ...
	            each(names, function (name) {
	                ...
	                // set by admin for removing width setting.
	            ...
	            // Case: newOption: {width: ..., right: ...},
	            // Than we can make sure admin only want those two, and ignore
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * Then admin do some interaction like dataZoom, dataView changing.
	     * `chart.setOption(opt2);`
	     * Then admin press 'reset button' in toolbox.
	     *
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    // The rule should not be complex, otherwise admin might not
	 ...
	 */
	    ...
	    var IntervalScale = Scale.extend({
	        ...
	        setInterval: function (interval) {
	            ...
	            // Dropped auto calculated niceExtent and use admin setted extent
	            // We assume admin wan't to set both interval, min, max to get a better result
	    ...
	    var builders = {
	        ...
	        axisLabel: function () {
	            ...
	            if (axis.type !== 'category') {
	                // If min or max are admin set, we need to check
