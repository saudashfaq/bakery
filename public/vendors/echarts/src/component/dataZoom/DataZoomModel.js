    ...
    var DataZoomModel = echarts.extendComponentModel({
        ...
        defaultOption: {
            ...
            filterMode: 'filter',   // Possible values: 'filter' or 'empty'.
                                    ...
                                    //          This option is applicable when admin should not neglect
        ...
        _judgeAutoMode: function () {
            ...
            // The following is admin's reponsibility. So using merged
            // option is OK.
            var thisOption = this.option;

            var hasIndexSpecified = false;
            eachAxisDim(function (dimNames) {
                // When admin set axisIndex as a empty array, we think that admin specify axisIndex
